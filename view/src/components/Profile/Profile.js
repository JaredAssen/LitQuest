...
const Profile = () => {
  ...
  const validateForm = () =>  {
    ...
    if (user.userid === 0 ) {
      ...
      // POST  
      fetch('http://localhost:5034/api/User/' + window.loggedUserId, {
        method: 'PUT',
        headers: {
    ...
    <div>
      ...
      <div className="profile">
        ...
        <section className="bio">
          <h2>About Me</h2>
          <form className = 'profile-form' name="profile" onSubmit={validateForm}>
            <input className = 'profile-input' type="text" id="about" name="about" defaultValue={about} size="50" />&nbsp;
            <input className = 'profile-input' type="button" value="Save" onClick={validateForm}/>
          </form>
        </section>
